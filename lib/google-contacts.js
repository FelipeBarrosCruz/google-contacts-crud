...
var GOOGLE_GROUPS_URI = 'https://www.google.com/m8/feeds/groups/default/full/';
var DEFAULT_HEADERS      = {
    'GData-Version': '3.0',
    'User-Agent'   : 'Client'
};
 ...
 */
GoogleContacts.prototype.addContact = bluebird.promisify(function (options, callback) {
    var self             = this;
 ...
 * @param callback(error, groups[])
 */
GoogleContacts.prototype.getGroup = bluebird.promisify(function (callback) {
    var self = this;

    var requestOptions = {
        uri: GOOGLE_GROUPS_URI,
        method: "GET",
        headers: lodash.defaults({
    ...
    self._auth.request(requestOptions, function (error, data, res) {
        ...
        ResponseParser.parseGetGroupsRawData(data, function (error, parsedData) {
            return callback(error, parsedData);
        });
    });
});
...
GoogleContacts.prototype.getContacts = bluebird.promisify(function (options, callback) {
    var self     = this;
    var contacts = [];
...
GoogleContacts.prototype.updateContacts = bluebird.promisify(function (data, updates, callback) {
  var self             = this;
  var options = {
    headers     :{                          // Optional
          'GData-Version': '3.0',
...
GoogleContacts.prototype.deleteContactsByFilter = bluebird.promisify(function (data, callback) {
  var self             = this;
  var options = {
    headers     :{                          // Optional
          'GData-Version': '3.0',
 ...
 * @param callback(error)
 */
GoogleContacts.prototype.deleteContacts = bluebird.promisify(function (options, callback) {
    var self = this;
...
GoogleContacts.prototype.refreshToken = bluebird.promisify(function (cb) {
