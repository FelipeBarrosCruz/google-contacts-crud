...
var CreateContact = function (contactInfo) {
    ...
    this._groupMembershipId = contactInfo.groupMembershipId || null;
...
CreateContact.prototype.getXml = function () {
    ...
    if (this._groupMembershipId) {
        obj['atom:entry']['gContact:groupMembershipInfo'] = {
            "@deleted": false,
            "@href": this._groupMembershipId
        }
    }
